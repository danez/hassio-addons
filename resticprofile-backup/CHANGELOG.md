...
- update ghcr.io/hassio-addons/base docker tag to v20.2.0 (#123)
...
- update ghcr.io/hassio-addons/base docker tag to v20.1.1 (#105)

# 2.0.11

- update dependency rclone to v1.74.0 (#104)

# 2.0.10

- update ghcr.io/hassio-addons/base docker tag to v20.1.0 (#102)

# 2.0.9

- update dependency rclone to v1.73.5 (#101)
...
- update ghcr.io/hassio-addons/base docker tag to v20.0.2 (#86)
